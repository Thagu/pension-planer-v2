  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2 lg:items-start lg:gap-6">
        <div className="min-w-0 rounded-xl border border-primary/20 bg-primary/[0.04] p-5">
          <p className="mb-4 text-sm font-semibold text-primary">{leftLabel}</p>
          {left}
        </div>
        {right ? (
          <div className="min-w-0 rounded-xl border border-violet-500/20 bg-violet-500/[0.05] p-5">
